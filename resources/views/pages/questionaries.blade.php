                                ...
                                <div class="md:my-2 md:mt-2 flex flex-col sm:flex-row items-end sm:items-center">
                                    <div class="flex items-center flex-grow">
                                        ...
                                        <div
                                            ...
                                            <div class="flex lg:items-start 2xl:items-center">
                                                <i class="text-blue-600 text-xl mr-2"></i>
                                                <p class="text-md">Have you achieved a minimum score in the qualifying
                                ...
                                <div class="md:my-2 md:mt-2 flex flex-col sm:flex-row items-end sm:items-center">
                                    <div class="flex items-center flex-grow w-full">
                                        ...
                                        <div
                                            ...
                                            <div class="flex lg:items-start 2xl:items-center">
                                                <i class="text-blue-600 text-xl mr-2"></i>
                                                <p class="text-md">Are You Married? <span
                                ...
                                <div class="md:my-2 md:mt-2 flex flex-col sm:flex-row items-end sm:items-center">
                                    <div class="flex items-center flex-grow w-full">
                                        ...
                                        <div
                                            ...
                                            <div class="flex lg:items-start 2xl:items-center">
                                                <i class="text-blue-600 text-xl mr-2"></i>
                                                <p class="text-md">Do You have more than one living spouse?<span
                                ...
                                <div class="md:my-2 md:mt-2 flex flex-col sm:flex-row items-end sm:items-center">
                                    <div class="flex items-center flex-grow w-full">
                                        ...
                                        <div
                                            ...
                                            <div class="flex lg:items-start 2xl:items-center">
                                                <i class="text-blue-600 text-xl mr-2"></i>
                                                <p class="text-md">Do you have Computer Certificate as per DP&AR
                                ...
                                <div class="md:my-2 md:mt-2 flex flex-col sm:flex-row items-end sm:items-center">
                                    <div class="flex items-center flex-grow w-full">
                                        ...
                                        <div
                                            ...
                                            <div class="flex lg:items-start 2xl:items-center">
                                                <i class="text-blue-600 text-xl mr-2"></i>
                                                <p class="text-md">Do you have an NCC Certificate? <span
                                                        class="text-red-600">*</span></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="md:my-2 md:mt-2 flex flex-col sm:flex-row items-end sm:items-center">
                                    <div class="flex items-center flex-grow w-full">
                                        ...
                                        <div
                                            ...
                                            <div class="flex lg:items-start 2xl:items-center">
                                                <i class="text-blue-600 text-xl mr-2"></i>
                                                <p class="text-md">Are you a Home Guard Volunteer (MRHG)? <span
                                                        class="text-red-600">*</span></p>
                                            </div>
                                        </div>
                                    </div>
